...
var insecureConfig = &tls.Config{
	...
	CipherSuites: []uint16{
		...
		tls.TLS_RSA_WITH_AES_128_CBC_SHA,     // insecure - required for legacy cameras without ECDHE support
		tls.TLS_RSA_WITH_AES_256_CBC_SHA,     // insecure - required for legacy cameras without ECDHE support
	},
}
